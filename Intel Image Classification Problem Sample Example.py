...
from tensorflow.keras.layers import Conv2D,Dense,MaxPooling2D,Activation,BatchNormalization,Dropout,Flatten
...
train_dataset = train.flow_from_directory(directory="C:/Users/Neelima/OneDrive/Desktop/seg_train",target_size=(50,50),shuffle=True)
test_dataset = test.flow_from_directory(directory="C:/Users/Neelima/OneDrive/Desktop/seg_test",target_size=(50,50),shuffle=True)
